...
export function AddListingButton({
  ...
  return (
    <Link
      ...
      data-slot="add-listing-button"
      data-variant={variant}
      className={cn(
        "inline-flex shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-xl bg-creation font-bold text-white shadow-[0px_4px_6px_-1px_rgba(249,115,22,0.2),0px_2px_4px_-2px_rgba(249,115,22,0.2)] transition-colors hover:bg-creation-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-creation/35 focus-visible:ring-offset-2",
