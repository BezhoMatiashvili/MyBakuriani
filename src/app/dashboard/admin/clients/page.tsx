...
export default function ClientsPage() {
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-foreground">კლიენტები</h1>
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <select
          ...
          className="rounded-lg border border-border bg-background px-3 py-2 text-sm text-foreground focus:border-brand-accent focus:outline-none"
        >
