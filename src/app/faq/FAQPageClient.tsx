...
const FAQ_ITEMS = [
  {
    ...
    answer: `აირჩიეთ სასურველი აპარტამენტი, მიუთითეთ შესვლისა და გასვლის თარიღები, სტუმრების რაოდენობა და დააჭირეთ \u201Eჯავშანი\u201C ღილაკს. მესაკუთრე დაადასტურებს თქვენს მოთხოვნას 24 საათის განმავლობაში.`,
  },
  {
