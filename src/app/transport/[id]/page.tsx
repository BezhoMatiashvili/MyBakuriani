...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) return { title: "ტრანსპორტი | MyBakuriani" };

  return {
    title: `${data.title} | ტრანსპორტი | MyBakuriani`,
    description: data.description ?? "ტრანსპორტი და ტრანსფერი ბაკურიანში",
  };
}
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <div className="mb-4 flex flex-wrap items-center gap-3">
            ...
            <Badge variant="secondary">ტრანსპორტი</Badge>
            {service.is_vip && (
          ...
          {service.driver_name && (
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">🚗 {service.driver_name}</p>
            </div>
          )}
          ...
          {service.route && (
            <div className="mb-6">
              ...
              <p className="text-muted-foreground">🛣️ {service.route}</p>
            </div>
          )}
