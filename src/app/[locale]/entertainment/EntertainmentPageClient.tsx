...
const SUB_CATEGORIES = [
  { value: "all", label: "ყველა" },
  { value: "inventory", label: "ინვენტარი" },
        ...
        <div className="mx-auto max-w-3xl">
          <ScrollReveal>
            <h1 className="text-[36px] font-black leading-[44px] sm:text-[48px] sm:leading-[56px]">
              <span className="text-[#60A5FA]">გართობა</span>{" "}
              <span className="text-white">და აქტივობები</span>
            </h1>
            <p className="mx-auto mt-4 max-w-xl text-[15px] leading-[24px] text-white/70">
              აღმოაჩინე ბაკურიანის საუკეთესო თავგადასავლები, ტურები და
              აღჭურვილობის გაქირავების წერტილები.
            </p>
          </ScrollReveal>
          <div className="mx-auto mt-8 flex max-w-[720px] items-center gap-2 rounded-full bg-white p-2 shadow-lg">
            <div className="flex flex-1 items-center gap-2 pl-4">
              ...
              <input
                ...
                placeholder="მოძებნე აქტივობა, ტური ან ინვენტარი..."
