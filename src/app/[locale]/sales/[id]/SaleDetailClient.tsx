        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {property.construction_status === "under_construction" ? (
            <motion.div {...fadeIn} transition={{ duration: 0.4, delay: 0.25 }}>
              ...
              <div className="space-y-4 rounded-xl border border-[#E2E8F0] p-5">
                <div className="flex items-center gap-3">
                  <Building2 className="h-6 w-6 text-brand-accent" />
                  <div className="min-w-0">
                    <p className="font-medium text-[#1E293B]">მშენებარე</p>
                    {property.developer && (
                ...
                <ConstructionProgressBar
                  percent={property.construction_progress_percent ?? 0}
                  label={
                    ...
                    <div className="flex items-center justify-between gap-2">
                      ...
                      {property.progress_note_updated_at && (
                        <span className="text-[10px] font-semibold text-[#94A3B8]">
                          {formatRelativeGe(property.progress_note_updated_at)}
                        </span>
                      )}
                    </div>
            ...
            <motion.div {...fadeIn} transition={{ duration: 0.4, delay: 0.25 }}>
              ...
              <div className="rounded-xl border border-[#E2E8F0] p-4">
                <div className="flex items-center gap-3">
                  <Building2 className="h-6 w-6 text-brand-accent" />
                  <div>
                    <p className="font-medium text-[#1E293B]">დასრულებული</p>
                    {property.developer && (
                      <p className="text-sm text-[#94A3B8]">
                        დეველოპერი: {property.developer}
                      </p>
