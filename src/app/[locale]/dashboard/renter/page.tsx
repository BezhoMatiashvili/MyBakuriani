    ...
    <div className="space-y-8 p-6 sm:p-8 lg:p-12">
      ...
      >
        <h1 className="text-[28px] font-black leading-[38px] text-[#0F172A]">
          {t("welcome", {
            name: profile?.display_name ?? t("defaultName"),
          })}
        </h1>
        <p className="text-sm font-medium text-[#64748B]">{t("subtitle")}</p>
      </motion.div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      ...
                      >
                        {t(`statuses.${property.status ?? "draft"}`)}
                      </span>
                      <span className="text-xs text-[#94A3B8]">
                        {t("views", { count: property.views_count ?? 0 })}
                      </span>
                    </div>
                  </div>
