...
import EntertainmentDetailClient from "@/app/[locale]/entertainment/[id]/EntertainmentDetailClient";
...
// /entertainment/[id] route is ISR and cookie-free; middleware rewrites ?preview=1
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) {
    return { title: t("detail.entertainmentNotFound"), robots: { index: false } };
  }
