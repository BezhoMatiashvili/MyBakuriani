...
import TransportDetailClient from "@/app/[locale]/transport/[id]/TransportDetailClient";
...
// /transport/[id] route is ISR and cookie-free; middleware rewrites ?preview=1
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) {
    return { title: t("detail.transportNotFound"), robots: { index: false } };
  }
