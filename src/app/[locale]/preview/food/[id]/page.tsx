...
import FoodDetailClient from "@/app/[locale]/food/[id]/FoodDetailClient";
...
// /food/[id] route is ISR and cookie-free; middleware rewrites ?preview=1
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) {
    return { title: t("detail.foodNotFound"), robots: { index: false } };
  }
