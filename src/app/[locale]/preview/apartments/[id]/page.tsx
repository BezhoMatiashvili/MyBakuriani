...
import ApartmentDetailClient from "@/app/[locale]/apartments/[id]/ApartmentDetailClient";
...
// /apartments/[id] route is ISR and cookie-free; middleware rewrites ?preview=1
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!data) {
    return { title: t("detail.apartmentNotFound"), robots: { index: false } };
  }
