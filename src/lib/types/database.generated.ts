...
// Source of truth: supabase/migrations/*.sql applied to the live project.
// Regenerate: npm run types:gen   (see scripts/gen-database-types.sh)
// Hand-written overrides live in ./database.ts, never here.
  ...
  public: {
    Tables: {
      ...
      content_change_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "content_change_requests_pricing_package_id_fkey";
          ...
          {
            foreignKeyName: "content_change_requests_target_menu_item_id_fkey";
            columns: ["target_menu_item_id"];
            isOneToOne: false;
            referencedRelation: "public_service_menu_items";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "content_change_requests_target_menu_item_id_fkey";
            columns: ["target_menu_item_id"];
            isOneToOne: false;
            referencedRelation: "service_menu_items";
            referencedColumns: ["id"];
          },
        ];
      };
      ...
      manual_booking_review_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "manual_booking_review_tokens_manual_booking_id_fkey";
      ...
      service_admin_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_admin_notes_service_id_fkey";
            columns: ["service_id"];
            isOneToOne: true;
            referencedRelation: "public_services";
            referencedColumns: ["id"];
      ...
      sms_outbound: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sms_outbound_source_manual_booking_id_fkey";
    ...
    Views: {
      ...
      public_properties: {
        Row: {
          ...
          construction_image_url: string | null;
          construction_progress_percent: number | null;
          construction_stages: string[] | null;
          construction_status: string | null;
          created_at: string | null;
          currency: string | null;
          description: string | null;
    ...
    Functions: {
      ...
      add_renter_guest_to_blacklist: {
        ...
        SetofOptions: {
          from: "*";
          to: "renter_guest_blacklist_result";
          isOneToOne: true;
          isSetofReturn: false;
        };
      };
      ...
      content_review_gate_column_drift: {
        Args: never;
        Returns: {
          column_name: string;
          issue: string;
      ...
      is_approved_org_member: { Args: { p_org_id: string }; Returns: boolean };
      ...
      manual_review_token_details: { Args: { p_token: string }; Returns: Json };
      ...
      self_service_publish_property_progress: {
        Args: {
          p_actor_id: string;
          p_note?: string;
          p_photos?: string[];
      ...
      sms_canonical_ge_phone: { Args: { p: string }; Returns: string };
      ...
      sms_create_manual_review_token: {
        Args: { p_manual_booking_id: string; p_owner_id: string };
        Returns: string;
      };
      sms_dispatch_batch: {
        Args: { p_limit?: number };
      ...
      sms_set_price_drop_rule: {
        Args: { p_enabled: boolean; p_owner_id: string; p_property_id: string };
        Returns: {
          created_at: string;
          enabled: boolean;
          owner_id: string;
    ...
    CompositeTypes: {
      renter_guest_blacklist_result: {
        guest: Database["public"]["Tables"]["renter_guests"]["Row"] | null;
        was_already_blacklisted: boolean | null;
      };
    };
  };
};
