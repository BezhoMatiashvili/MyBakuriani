...
export const getPropertyById = cache(
  async (
    ...
    try {
      ...
      //  - admin: service-role bypasses RLS to preview any status.
      ...
      //    a creator read their own pending listing — the anon public client sends
      //    no cookie, so the owner branch can never match.
